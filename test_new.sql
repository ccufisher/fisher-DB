...
VALUES (1, 'JohnDoe', 30, 'USA', 'USA1234567890', 'engineer', LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\jane.png')),
       (2, 'JaneSmith',  25, 'Canada', 'CAN1234567890', 'fisherman', LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\jane.png'));
...
VALUES (1, '2024-11-27', '1', 5, LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\jane.png'), LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\jane.png'), 1, 'Normal shift'),
       (2, '2024-11-27', '0', 12, LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\jane.png'), LOAD_FILE('C:\\ProgramData\\MySQL\\MySQL Server 8.0\\Uploads\\jane.png'), 0, 'Lunch break');
